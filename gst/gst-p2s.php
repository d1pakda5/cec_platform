...
<head>
<title>Surcharge-Invoice-<?php echo $invoice_num;?></title>
	...
	<div class="container">
		<div id="divPrint">
			...
			<table class="table table-bordered" cellspacing="0">
				...
				<?php		
				$hsn1 = $db->queryUniqueObject("SELECT * FROM gstinvoicesitems WHERE invoiceid='".$invoiceid."' AND hsn_sac='998592' ");
				$gst_sum1 = $gst->getTaxSummary($hsn1->net_amount,$user->gst_type);
				$tax_total1 = $gst_sum1['cgst_amount']+$gst_sum1['sgst_amount']+$gst_sum1['igst_amount'];
				?>
				<tr>
					<td><?php echo $hsn1->hsn_sac;?></td>
					<td align="right"><?php echo $hsn1->taxable_amount;?></td>
					<td width="7%"><?php echo $gst_sum1['cgst_rate'];?></td>
					<td width="12%" align="right"><?php echo $gst_sum1['cgst_amount'];?></td>
					<td width="7%"><?php echo $gst_sum1['sgst_rate'];?></td>
					<td width="12%" align="right"><?php echo $gst_sum['sgst_amount'];?></td>
					<td width="7%"><?php echo $gst_sum1['igst_rate'];?></td>
					<td width="12%" align="right"><?php echo $gst_sum1['igst_amount'];?></td>
					<td align="right"><?php echo $tax_total1;?></td>
				</tr>
				<?php		
				$hsn2 = $db->queryUniqueObject("SELECT * FROM gstinvoicesitems WHERE invoiceid='".$invoiceid."' AND hsn_sac='997159' ");
				$gst_sum2 = $gst->getTaxSummary($hsn2->net_amount,$user->gst_type);
				$tax_total2 = $gst_sum2['cgst_amount']+$gst_sum2['sgst_amount']+$gst_sum2['igst_amount'];
				?>
				<tr>
					<td><?php echo $hsn2->hsn_sac;?></td>
					<td align="right"><?php echo $hsn2->taxable_amount;?></td>
					<td width="7%"><?php echo $gst_sum2['cgst_rate'];?></td>
					<td width="12%" align="right"><?php echo $gst_sum2['cgst_amount'];?></td>
					<td width="7%"><?php echo $gst_sum2['sgst_rate'];?></td>
					<td width="12%" align="right"><?php echo $gst_sum2['sgst_amount'];?></td>
					<td width="7%"><?php echo $gst_sum2['igst_rate'];?></td>
					<td width="12%" align="right"><?php echo $gst_sum2['igst_amount'];?></td>

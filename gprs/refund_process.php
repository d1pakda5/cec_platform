...
if((!isset($_GET['recharge_id']) && $_GET['recharge_id'] == '') || (!isset($_GET['action']) && $_GET['action'] == '')) {
	if($_GET['recharge_id']=='') {
	...
	$recharge_id = htmlentities(addslashes($_GET['recharge_id']),ENT_QUOTES);	
	$post_complaint_id = htmlentities(addslashes($_GET['complaint_id']),ENT_QUOTES);	
	$action = htmlentities(addslashes($_GET['action']),ENT_QUOTES);			
	$remark = htmlentities(addslashes($_GET['remark']),ENT_QUOTES);
	$operator_ref_no = htmlentities(addslashes($_GET['operator_ref_no']),ENT_QUOTES);
	$is_complaint = false;

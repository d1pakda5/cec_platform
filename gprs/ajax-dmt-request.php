...
if(isset($_GET['uid']) && $_GET['uid']!='' && isset($_GET['amount']) && $_GET['amount']!='') {
	$uid = $_GET['uid'];
	...
	if($aRequestDmt->dmt_update_status=='1') { 
		echo "Your request has been accepted, If you see this message please logout and login again";
		exit();
		
		 }
	 if($agent_info->user_type == 4)
	    {

...
$db->execute("INSERT INTO `mt_logs`(`mt_logs_id`, `mt_logs_date`, `mt_logs_type`, `mt_logs`) VALUES ('', NOW(), 'MONEY PRE CHECK', '".$signInResult[1]."')");

$checkOutput = $sp->cpRequest($signInResult[1], $cpUrl['check']);

$db->execute("INSERT INTO `mt_logs`(`mt_logs_id`, `mt_logs_date`, `mt_logs_type`, `mt_logs`) VALUES ('', NOW(), 'MONEY RSP CHECK', '".$checkOutput."')");

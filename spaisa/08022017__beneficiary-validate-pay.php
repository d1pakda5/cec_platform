...
$db->execute("INSERT INTO `mt_logs`(`mt_logs_id`, `mt_logs_date`, `mt_logs_type`, `mt_logs`) VALUES ('', NOW(), 'BENE VALIDATE PAY', '".$payOutput."')");	
...
if($dmt_pay_error=='0' && $dmt_pay_result=='0') {
	...
	$jsDmtResponse = '{"ResponseCode":"0","Message":"Verification for beneficary is successful.","RequestNo":"'.$jsFetch['RequestNo'].'","MobileNo":"'.$jsFetch['MobileNo'].'","MoneyRemittance":'.$jsMoneyRemittance.',"Beneficiary":'.$jsBeneficiary.',"Recharge":'.$jsRecharge.'}';	
	$status = "0";

...
if(strpos($checkExplode['6'], 'ERROR=0')!==false) {
	...
	if(strpos($payExplode['6'], 'ERROR=0')!==false) {
		...
		$jsDmtResponse = '{"ResponseCode":"0","Message":"Money Remittance transaction is successful","RequestNo":"'.$jsFetch['RequestNo'].'","MobileNo":"'.$jsFetch['MobileNo'].'","MoneyRemittance":'.$jsMoneyRemittance.',"Beneficiary":'.$jsBeneficiary.'}';	

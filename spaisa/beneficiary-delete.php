...
if(strpos($checkExplode['6'], 'ERROR=0')!==false) {
	...
	if(strpos($payExplode['6'], 'ERROR=0')!==false) {
		...
		$jsDmtResponse = '{"ResponseCode":"0","Message":"Verification code for beneficary delete, sent on requested mobile.","RequestNo":"'.$jsFetch['RequestNo'].'","MobileNo":"'.$jsFetch['MobileNo'].'"}';

...
$beneficiaryAdd = $sp->cpBeneficiaryAdd($account,$request_txn_no,$ben_name,$bank_account,$ifsc);	
...
//  		print_r($payOutput);	
	if(strpos($payExplode['6'], 'ERROR=0')!==false) {
		...
		$jsDmtResponse = '{"ResponseCode":"0","Message":"Verification code for beneficary add is sent on requested mobile.","RequestNo":"'.$jsFetch['RequestNo'].'","MobileNo":"'.$jsFetch['MobileNo'].'"}';

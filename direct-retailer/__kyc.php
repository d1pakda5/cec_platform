							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									...
									<p class="form-control-static">
										<?php if($address_proof_type=='driving'){ echo "Driving License";} elseif($address_proof_type=='passport') { echo "Passport Number"; } elseif($address_proof_type=='voterid') { echo "Election ID Card";} elseif($address_proof_type=='aadhar') { echo "Aadhar Card";}?>
									</p>
								</div>
								<div class="col-sm-3">

...
if(isset($_POST['submit'])) {	
	if($_POST['firstname']=='' || $_POST['lastname']=='' ||  $_POST['dob']=='' || $_POST['gender']=='' || $_POST['mobile']=='' || $_POST['email']=='' || $_POST['permanent_address']=='' || $_POST['correspondence_address']=='' || $_POST['city']=='' || $_POST['pincode']=='' || $_POST['pancard_number']=='' || $_POST['aadhaar_number']=='' || $_POST['address_proof_type']=='' || $_POST['address_proof_doc_no']=='' || $_POST['business_name']=='' || $_POST['business_address']=='' || $_POST['business_type']=='') {
		$error = 1;
	} else {
		...
		*/
		...
		if($kyc_type=='add') {
			$db->execute("INSERT INTO `apps_user_kyc`(`kyc_id`, `user_id`, `firstname`, `middlename`, `lastname`, `fathername`, `dob`, `gender`, `mobile`,`email`, `permanent_address`, `correspondence_address`, `city`, `pincode`, `pancard_number`, `aadhaar_card_number`, `address_proof_type`, `address_proof_doc_no`, `business_name`, `business_address`, `business_type`, `business_type_detail`, `passport`, `pancard`, `addressproof1`, `addressproof2`, `added_date`, `added_by`) VALUES ('', '".$request_id."', '".$firstname."', '".$middlename."', '".$lastname."', '".$fathername."', '".$dob."', '".$_POST['gender']."', '".$mobile."', '".$email."', '".$permanent_address."', '".$correspondence_address."', '".$city."', '".$pincode."', '".$pancard_number."', '".$aadhaar_card_number."', '".$_POST['address_proof_type']."', '".$address_proof_doc_no."', '".$business_name."', '".$business_address."', '".$_POST['business_type']."', '".$business_type_detail."', '".$pp_img."', '".$pc_img."', '".$ap1_img."', '".$ap2_img."', NOW(), '".$aRetailer->uid."')");
			$db->execute("UPDATE `apps_user` SET `is_kyc`='y' WHERE user_id='".$request_id."' ");
			header("location:kyc.php?token=".$token."&error=3");	
			exit();		
		} else {
			$db->execute("UPDATE `apps_user_kyc` SET `firstname`='".$firstname."', `middlename`='".$middlename."', `lastname`='".$lastname."', `fathername`='".$fathername."',`dob`='".$dob."', `gender`='".$_POST['gender']."', `mobile`='".$mobile."',`email`='".$email."', `permanent_address`='".$permanent_address."', `correspondence_address`='".$correspondence_address."', `city`='".$city."', `pincode`='".$pincode."', `pancard_number`='".$pancard_number."', `aadhaar_card_number`='".$aadhaar_card_number."', `address_proof_type`='".$_POST['address_proof_type']."', `address_proof_doc_no`='".$address_proof_doc_no."', `business_name`='".$business_name."', `business_address`='".$business_address."', `business_type`='".$_POST['business_type']."', `business_type_detail`='".$business_type_detail."', `update_date`=NOW(), `update_by`='".$aRetailer->uid."', `is_edit`='n' WHERE kyc_id='".$kyc_id."' ");
...
$kyc = $db->queryUniqueObject("SELECT * FROM apps_user_kyc WHERE user_id='".$aRetailer->user_id."' ");
if($kyc) {
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<div class="col-sm-4">
										<label>Middle Name<i class="text-red">*</i></label>
										<div class="jrequired">
								...
								<div class="form-group">
									<div class="col-sm-4">
										<label>Father Name<i class="text-red">*</i></label>
										<div class="jrequired">
								...
								<div class="form-group">
									<div class="col-sm-3">
										<label>Mobile Number<i class="text-red">*</i></label>
										<div class="jrequired">
								...
								<div class="form-group">
									<div class="col-sm-6">
										<label>Permanent Address<i class="text-red">*</i></label>
										<div class="jrequired">
									...
									<div class="col-sm-6">
										<label>Correspondence Address<i class="text-red">*</i></label>
										<div class="jrequired">
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
										<label>Pincode<i class="text-red">*</i></label>
										<div class="jrequired">
								...
								<div class="form-group">
									<div class="col-sm-3">
										<label>Pancard Number<i class="text-red">*</i></label>
										<div class="jrequired">
									...
									<div class="col-sm-3">
										<label>Aadhaar Number<i class="text-red">*</i></label>
										<div class="jrequired">
									...
									<div class="col-sm-3">
										<label>Address Proof Doc Type<i class="text-red">*</i></label>
										<div class="jrequired">
										<select name="address_proof_type" id="address_proof_type" class="form-control">
											<option value=""></option>							
											<option value='aadhar' <?php if($address_proof_type=='aadhar'){?>selected="selected"<?php } ?>>Aadhar Card</option>	
									...
									<div class="col-sm-3">
										<label>Address Proof Doc Ref No<i class="text-red">*</i></label>
										<div class="jrequired">
								...
								<div class="form-group">									
									<div class="col-sm-6">
										<label>Business Type<i class="text-red">*</i></label>
										<div class="jrequired">
								...
								<div class="form-group">
									<div class="col-sm-6">
										<label>Business Name<i class="text-red">*</i></label>
										<div class="jrequired">
									...
									<div class="col-sm-6">
										<label>Bussiness Address<i class="text-red">*</i></label>
										<div class="jrequired">
								...
								<div class="form-group">
									<label class="col-sm-3">Photograph<i class="text-red">*</i></label>
									<div class="col-sm-8">
										<div class="jrequired">
								...
								<div class="form-group">
									<label class="col-sm-3">Pancard<i class="text-red">*</i></label>
									<div class="col-sm-8">
										<div class="jrequired">
								...
								<div class="form-group">
									<label class="col-sm-3">Aadhaar Card / Voter ID<i class="text-red">*</i></label>
									<div class="col-sm-8">
										<div class="jrequired">
								...
								<div class="form-group">
									<label class="col-sm-3">Address Proof (1)<i class="text-red">*</i></label>
									<div class="col-sm-8">
										<div class="jrequired">

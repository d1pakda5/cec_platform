			...
			<div class="box-body no-padding">
				<table class="table table-striped">
					...
					<tbody>
						<?php					
						$scnt = 1;
						$query = $db->query("SELECT opr.operator_name, opr.operator_longcode, opr.minimum_amount, opr.maximum_amount, opr.service_type, opr.status, ser.service_name, com.status AS com_status FROM operators opr LEFT JOIN service_type ser ON opr.service_type = ser.service_type_id LEFT JOIN apps_commission com ON opr.operator_id = com.operator_id AND com.uid = '".$aRetailer->mdist_id."' ORDER BY opr.service_type, opr.operator_name ASC");

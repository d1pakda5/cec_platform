					...
					<div class="box-body">	
						<div class="form-horizontal">
							<div class="form-group">
								<label class="col-sm-2 control-label">Sender<i class="text-red">*</i> :</label>
								<div class="col-sm-4">
					...
					<div class="box">
						...
						<div class="box-body">	
							<form id="frmSenderRegister" class="form-horizontal">
								<div class="form-group">
									<label class="col-sm-3 control-label">First Name<i class="text-red">*</i> :</label>
									<div class="col-sm-5">
										<input type="text" name="fname" id="fname" class="form-control" placeholder="Enter First Name" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">Last Name<i class="text-red">*</i> :</label>
									<div class="col-sm-5">
										<input type="text" name="lname" id="lname" class="form-control" placeholder="Enter Last Name" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">Mobile Number<i class="text-red">*</i> :</label>
									<div class="col-sm-5">
					...
					<div class="dmt box">
						...
						<div class="box-body">	
							<form id="frmBeneficiaryRegister" class="form-horizontal">
								<div class="form-group">
									<label class="col-sm-3 control-label">Beneficiary Name<i class="text-red">*</i> :</label>
									<div class="col-sm-5">
										<input type="text" name="ben_name" id="ben_name" class="form-control" placeholder="Enter Beneficiary Name" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">Bank Account<i class="text-red">*</i> :</label>
									<div class="col-sm-5">
										<input type="text" name="ben_account" id="ben_account" class="form-control" placeholder="Enter Bank Account Number" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">IFSC<i class="text-red">*</i> :</label>
									<div class="col-sm-5">
										<div class="row">
											<div class="col-sm-8">
			...
			<div class="modal-body">
				...
				<div class="col-sm-12">
					<form id="frmIfscSearch" class="form-horizontal">
						<div class="form-group">
							<label class="col-sm-4 control-label">Bank Name<i class="text-red">*</i> :</label>
							<div class="col-sm-6">
								<input type="text" name="bank_name" id="bank_name" class="form-control" placeholder="Enter Bank Name" />
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">Branch/City Name<i class="text-red">*</i> :</label>
							<div class="col-sm-6">
				...
				<div class="row">
					<div class="col-sm-12">
						<form id="frmOtcConfirm" class="form-horizontal">
							<div class="form-group">
								<label class="col-sm-4 control-label">OTC Reference No<i class="text-red">*</i> :</label>
								<div class="col-sm-6">
									<input type="text" name="otc_ref_no" id="otc_ref_no" readonly="" class="form-control" placeholder="Enter Reference" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4 control-label">OTC<i class="text-red">*</i> :</label>
								<div class="col-sm-6">
				...
				<div class="row">
					<div class="col-sm-12">
						<form id="frmMoneyRemittance" class="form-horizontal">
							...
							<div class="form-group">
								<label class="col-sm-4 control-label">Amount<i class="text-red">*</i> :</label>
								<div class="col-sm-7">

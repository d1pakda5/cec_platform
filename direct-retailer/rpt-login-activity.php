...
$sWhere = "WHERE username = '".$aRetailer->username."' AND user_type = '5' ";
if(isset($_GET['s']) && $_GET['s'] != '') {
	$sWhere .= " AND ( ip LIKE '%".mysql_real_escape_string($_GET['s'])."%' OR browser LIKE '%".mysql_real_escape_string($_GET['s'])."%' )  ";
} else {

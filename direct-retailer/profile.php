				...
				<div class="box">
					...
					<div class="box-body padding-50 min-height-300">						
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									<label class="col-sm-4 control-label">UID<i class="text-red">*</i> :</label>
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label class="col-sm-4 control-label">Username<i class="text-red">*</i> :</label>
									<div class="col-sm-8 jrequired">
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									<label class="col-sm-4 control-label">Full Name<i class="text-red">*</i> :</label>
									<div class="col-sm-8 jrequired">
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label class="col-sm-4 control-label">Company Name<i class="text-red">*</i> :</label>
									<div class="col-sm-8 jrequired">
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									<label class="col-sm-4 control-label">Mobile<i class="text-red">*</i> :</label>
									<div class="col-sm-8 jrequired">
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									<label class="col-sm-4 control-label">Email<i class="text-red">*</i> :</label>
									<div class="col-sm-8 jrequired">
						...
						<div class="row">
							<div class="col-sm-6">							
								<div class="form-group">
									<label class="col-sm-4 control-label">Address<i class="text-red">*</i> :</label>
									<div class="col-sm-8 jrequired">
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label class="col-sm-4 control-label">City<i class="text-red">*</i> :</label>
									<div class="col-sm-8 jrequired">
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									<label class="col-sm-4 control-label">State<i class="text-red">*</i> :</label>
									<div class="col-sm-8 jrequired">
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label class="col-sm-4 control-label">Pincode<i class="text-red">*</i> :</label>
									<div class="col-sm-8 jrequired">
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									<label class="col-sm-4 control-label">PAN Number<i class="text-red">*</i> :</label>
									<div class="col-sm-8 jrequired">
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label class="col-sm-4 control-label">Aadhar Number<i class="text-red">*</i> :</label>
									<div class="col-sm-8 jrequired">
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									<label class="col-sm-4 control-label">GSTIN ID<i class="text-red">*</i> :</label>
									<div class="col-sm-8 jrequired">

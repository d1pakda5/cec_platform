			...
			<div class="box-body no-padding">
				<table class="table table-striped">
					...
					<tbody>
						...
						$query = $db->query("SELECT opr.operator_name, opr.service_type, ser.service_name, com.comm_ret, com.is_surcharge,com.surcharge_value, com.is_percentage FROM operators opr LEFT JOIN service_type ser ON opr.service_type = ser.service_type_id LEFT JOIN usercommissions com ON opr.operator_id = com.operator_id AND com.uid = '".$aRetailer->uid."' ORDER BY opr.service_type, opr.operator_name ASC");

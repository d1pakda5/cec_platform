...
$_uid = $_SESSION['retailer_uid'];

if(isset($_POST['skip'])) {
    $_SESSION['retailer_kyc']='1';
    header("location:index.php");
}

if(isset($_POST['submit'])) {	
	if($_POST['firstname']=='' || $_POST['lastname']=='' || $_POST['fathersname']=='' || $_POST['dob']=='' || $_POST['gender']=='' || $_POST['email']=='' || $_POST['mobile']=='' || $_POST['addressperm']=='' || $_POST['addresscorres']=='' || $_POST['city']=='' || $_POST['state']=='' || $_POST['pincode']=='' || $_POST['pancard']=='' || $_POST['adrprooftype']=='' || $_POST['adrprooftypeno']=='' || $_POST['businessname']=='' || $_POST['businessaddress']=='' || $_POST['businesstype']=='') {
		$error = 1;
	} else {
		...
		*/
		...
		if($action=='add') {
			$db->execute("INSERT INTO `userskyc`(`uid`, `firstname`, `middlename`, `lastname`, `fathersname`, `dob`, `gender`, `mobile`, `email`, `addressperm`, `addresscorres`, `city`, `state`, `pincode`, `pancard`, `aadhaar`, `gstin`, `adrprooftype`, `adrprooftypeno`, `businessname`, `businessaddress`, `businesstype`, `businesstypename`, `photofile`, `pancardfile`, `aadhaarfile`, `addressfile`, `submitdate`, `submitedby`, `status`) VALUES ('".$uid."', '".$firstname."', '".$middlename."', '".$lastname."', '".$fathersname."', '".$dob."', '".$_POST['gender']."', '".$mobile."', '".$email."', '".$addressperm."', '".$addresscorres."', '".$city."', '".$_POST['state']."', '".$pincode."', '".$pancard."', '".$aadhaar."', '".$gstin."', '".$_POST['adrprooftype']."', '".$adrprooftypeno."', '".$businessname."', '".$businessaddress."', '".$_POST['businesstype']."', '".$businesstypename."', '".$photofile."', '".$pancardfile."', '".$aadhaarfile."', '".$addressfile."', NOW(), '".$uid."', '0')");
			$db->execute("UPDATE `apps_user` SET `is_kyc`='1' WHERE uid='".$uid."' ");
			
				
		} else {
			
			$db->execute("UPDATE `userskyc` SET `firstname`='".$firstname."', `middlename`='".$middlename."', `lastname`='".$lastname."', `fathersname`='".$fathersname."',`dob`='".$dob."', `gender`='".$_POST['gender']."', `mobile`='".$mobile."',`email`='".$email."', `addressperm`='".$addressperm."', `addresscorres`='".$addresscorres."', `city`='".$city."', `state`='".$_POST['state']."', `pincode`='".$pincode."', `pancard`='".$pancard."', `aadhaar`='".$aadhaar."', `gstin`='".$gstin."', `adrprooftype`='".$_POST['adrprooftype']."', `adrprooftypeno`='".$adrprooftypeno."', `businessname`='".$businessname."', `businessaddress`='".$businessaddress."', `businesstype`='".$_POST['businesstype']."', `businesstypename`='".$businesstypename."', `updatedate`=NOW(), `updatedby`='".$uid."', `canedit`='0', `status`='0' WHERE uid='".$uid."' ");
...
<div class="content">
	<div class="container">
		<div class="page-header">
			<div class="page-title">My Account <small>/ KYC  </small>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(Please Update KYC to login)</div>
			<div class="pull-right">
			    <form action="" method="post" id="skip" enctype="multipart/form-data">
			    <button type="submit" name="skip" id="skip" class="btn btn-success btn-lg">Skip</button>
			    </form>
			</div>
		</div>
		<?php if($error == 3) { ?>
						...
						<div class="row">
							<div class="col-md-8">
								<div class="form-group">
									<div class="col-sm-4">
										<label>UID<i class="text-red">*</i></label>
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<label>Document Ref No Details<i class="text-red">*</i></label>
										<div class="jrequired">
							...
							<div class="col-md-4">
								...
								<div class="form-group">
									<div class="col-sm-12">
										<label>Business address<i class="text-red">*</i></label>
							...
							<div class="col-md-12">
								...
								<div class="form-group">
									<div class="col-sm-3">
										<label>Photograph<i class="text-red">*</i></label>
										<input type="file" name="photofile" id="photoFile">
									</div>
									<div class="col-sm-3">
										<label>Pancard<i class="text-red">*</i></label>
										<input type="file" name="pancardfile" id="pancardFile">
									</div>
									<div class="col-sm-3">
										<label>Aadhaar Card / Voter ID<i class="text-red">*</i></label>
										<input type="file" name="aadhaarfile" id="aadhaarFile">
									</div>
									<div class="col-sm-3">
										<label>Address Proof<i class="text-red">*</i></label>

...
//
$statement = "gst_monthlytxns gst LEFT JOIN apps_user usr ON gst.uid=usr.uid $sWhere GROUP BY gst.uid ORDER BY gst.uid ASC";
				...
				<table class="table table-condensed table-striped table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td><?php echo date("m, Y", strtotime($row->rch_date));?></td>
							...
							<td align="center"><a href="gst-p2a-dr.php?id=<?php echo $row->uid;?>&month=<?php echo $month;?>&year=<?php echo $year;?>" target="_blank" class="btn btn-success btn-xs">Receipt</a></td>
						</tr>
						<?php } ?>
					</tbody>
				</table>

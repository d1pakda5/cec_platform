...
$arUser1 = array();
$qry1 = $db->query("SELECT * FROM apps_user WHERE user_type = '3' $sArray ");
						...
						<div class="col-sm-4">
							<div class="form-group">
								<select name="muid" class="form-control">
									...
									<option value="<?php echo $data['uid'];?>" <?php if(isset($_GET['muid']) && $_GET['muid'] == $data['uid']) { ?> selected="selected"<?php } ?>><?php echo $data['name'];?></option>
									<?php } ?>
								</select>
							</div>
						</div>
					...
					<tbody>
						...
						<tr>
							...
							<td style="text-align:center;">
								<a href="retailer.php?duid=<?php echo $result->uid;?>" title="Retailer">

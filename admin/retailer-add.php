...
if(isset($_POST['submit'])) {
	if($_POST['fullname'] == '' || $_POST['company_name'] == '' || $_POST['mobile'] == '' || $_POST['email'] == '' || $_POST['address'] == '' || $_POST['state'] == '' || $_POST['uid'] == '' || $_POST['status'] == '' || $_POST['mdist_id'] == '' || $_POST['password'] == '') {
		$error = 1;		
	} else {		
		...
		if($exists) {
			...
			$websitename = getWebsiteName($_POST['mdist_id']);

...
if(isset($_GET['s']) && $_GET['s']!='') {
	$sWhere = " WHERE (trans.remark LIKE '%".mysql_real_escape_string($_GET['s'])."%' OR trans.transaction_ref_no LIKE '%".mysql_real_escape_string($_GET['s'])."%' OR trans.amount LIKE '%".mysql_real_escape_string($_GET['s'])."%') ";
} else {
...
function doExcel(){
	...
	window.location='excel/user-transaction.php?from='+from+'&to='+to+'&type='+type+'&uid='+uid;
}
</script>

...
if(isset($_GET['s']) && $_GET['s'] != '') {
	...
	$sWhere .= " AND ( recharge.recharge_id='".$aStr."' OR recharge.account_no='".$aStr."' OR recharge.operator_ref_no LIKE '%".$aStr."%' OR recharge.api_txn_no LIKE '%".$aStr."%' OR recharge.api_txn_no LIKE '%".$aStr."%' OR user.company_name LIKE '%".$aStr."%' ) ";
}

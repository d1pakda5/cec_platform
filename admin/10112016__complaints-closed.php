				...
				<table class="table table-striped table-bordered table-condensed">
					...
					<tbody>
						...
						<tr>
							...
							<td> 
								<a class="fancyDetails fancybox.ajax" href="recharge-refund.php?&id=<?php echo $result->recharge_id;?>&cid=<?php echo $result->complaint_id;?>" title="Complaint Details"><img src="../images/comp_0.png" /></a>
							</td>
							<td> 

					...
					<tbody>
						...
						<tr>
							...
							<td style="text-align:center;">
								<a href="denomination.php?o=<?php echo $result->operator_id;?>" title="Denominations" class="btn btn-xs btn-info"><i class="fa fa-inr"></i></a>
							</td>
							<td align="center">
							...
							<td style="text-align:center;">
								<a href="#" onClick="editRow('<?php echo $result->operator_id;?>');" title="Edit" class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i></a>
							</td>
						</tr>
						<?php } ?>
					</tbody>

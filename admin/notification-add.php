...
if(isset($_POST['submit'])) {
	if($_POST['ntype']=='' || $_POST['notification']=='' || $_POST['status']=='') {
		...
		if($can_update) {
			$db->execute("INSERT INTO `notifications`(`notification_id`, `user_type`, `ntype`, `ctype`, `notification_content`, `notification_files`, `notification_date`, `status`) VALUES ('', '".$_POST['user_type']."', '".$_POST['ntype']."', '".$_POST['ctype']."', '".$notification."', '".$file."', NOW(), '".$_POST['status']."')");
			$error = 3;
					...
					<div class="col-md-12">
						...
						<div id="textPane" class="form-group">
							...
							<div class="col-sm-8 jrequired">
								...
								<a href="https://www.tinymce.com/docs/demo/basic-example/#liveexample" target="_blank">Editor</a>
							</div>
						</div>

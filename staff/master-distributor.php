				...
				<table class="table table-condensed table-striped table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td style="text-align:center;"><a href="distributor.php?muid=<?php echo $result->uid;?>" title="Distributor" class="btn btn-xs btn-default"><i class="fa fa-user"></i></a></td>

...
if(isset($_POST['submit'])) {
	if($_POST['fullname']=='' || $_POST['company_name']=='' || $_POST['mobile']=='' || $_POST['email']=='' || $_POST['address']=='' || $_POST['state']=='' || $_POST['uid']=='' || $_POST['status']=='' || $_POST['password']=='') {
		...
		if($exists) {
			...
			$db->execute("INSERT INTO `apps_user`(`uid`, `user_type`, `mdist_id`, `dist_id`, `fullname`, `company_name`, `mobile`, `phone`, `email`, `address`, `states`, `city`, `pincode`, `aadhaar`, `tds_deduct`, `tds_per`, `panno`, `gst_deduct`, `has_gst`, `gstin`, `gst_type`, `bill_address`, `bill_pincode`, `bill_city`, `bill_state`, `username`, `password`, `pin`, `is_access`, `is_verified`, `is_kyc`, `is_recharge`, `is_money`, `is_deduct`, `status`, `added_date`) VALUES ('".$uid."', '1', '0', '0', '".$fullname."', '".$company_name."', '".$mobile."', '".$phone."', '".$email."', '".$address."', '".$_POST['state']."', '".$city."', '".$pincode."', '".$aadhaar."', '".$tds_deduct."', '".$tds_per."', '".$panno."', '".$gst_deduct."', '".$has_gst."', '".$gstin."', '".$_POST['gst_type']."', '".$bill_address."', '".$bill_pincode."', '".$bill_city."', '".$_POST['bill_state']."', '".$mobile."', '".$hashPassword."', '1234', '".$is_access."', '".$is_verified."', '0', '1', '0', '0', '".$_POST['status']."', NOW())");
...
<div class="content">
	<div class="container-fluid">
		<div class="page-header">
			<div class="page-title">API User <small>/ Add</small></div>
			...
			<div class="col-sm-12">
				<div class="box">
					<div class="box-header">
						<h3 class="box-title"><i class="fa fa-plus-square"></i> Create new api user</h3>
					</div>
						...
						<div class="row padding-50">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="col-sm-8 jrequired">
										<input type="text" name="uid" id="uid" readonly="" value="<?php echo getUserUID();?>" class="form-control no-full-width">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-4 control-label">Username :</label>
									<div class="col-sm-8 jrequired">
										<input type="text" name="username" id="username" readonly="" class="form-control no-full-width">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-4 control-label">Password :</label>
									<div class="col-sm-8 jrequired">
										<input type="text" name="password" id="password" class="form-control no-full-width">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-4 control-label">Cutoff :</label>
									<div class="col-sm-8 jrequired">
										<input type="text" name="cuttoff" id="cuttoff" class="form-control no-full-width">
									</div>
								</div>
								<div class="form-group">

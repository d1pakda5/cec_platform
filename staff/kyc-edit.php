...
if(isset($_POST['submit'])) {	
	if($_POST['firstname']=='' || $_POST['lastname']=='' || $_POST['fathersname']=='' || $_POST['mothersname']=='' || $_POST['dob']=='' || $_POST['gender']=='' || $_POST['email']=='' || $_POST['mobile']=='' || $_POST['addressperm']=='' || $_POST['addresscorres']=='' || $_POST['city']=='' || $_POST['state']=='' || $_POST['pincode']=='' || $_POST['pancard']=='' || $_POST['adrprooftype']=='' || $_POST['adrprooftypeno']=='' || $_POST['businessname']=='' || $_POST['businessaddress']=='' || $_POST['businesstype']=='') {
		...
		*/
		...
		header("location:kyc-edit.php?id=".$requestid."&error=3");	
		exit();
	}
}
...
jQuery(document).ready(function(){
	...
	jQuery('#kycForm').validate({
	  rules: {
			...
			photofile: {required: false,accept: "png|jpeg|gif",filesize: 2097152},
			pancardfile: {required: false,accept: "png|jpeg|gif",filesize: 2097152},
			aadhaarfile: {required: false,accept: "png|jpeg|gif",filesize: 2097152},
			addressfile: {required: false,accept: "png|jpeg|gif",filesize: 2097152}
	  },
...
<div class="content">
	<div class="container-fluid">
		<div class="page-header">
			<div class="page-title">KYC <small>/ Edit</small></div>
			<div class="pull-right">
				<a href="kyc.php?uid=<?php echo $uid;?>" class="btn btn-default"><i class="fa fa-eye"></i> View KYC</a>
						...
						<div class="row">
							...
							<div class="col-md-12" style="margin-bottom:40px;">
								<div class="form-group">
									<div class="col-md-12">
										<label>
											<input type="checkbox" name="declare" id="declare"> I have checked KYC
										</label>
									</div>									
								</div>
							</div>

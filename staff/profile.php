...
if(isset($_POST['submit'])) {
	if($_POST['fullname'] == '' || $_POST['mobile'] == '' || $_POST['email'] == '') {
		...
		$db->execute("UPDATE `apps_admin` SET `fullname` = '".$fullname."', `mobile` = '".$mobile."', `email` = '".$email."' WHERE `admin_id` = '".$_SESSION['staff']."' ");
		$error = 3;
	}
}
$profile = $db->queryUniqueObject("SELECT * FROM apps_admin WHERE admin_id = '".$_SESSION['staff']."' ");
$meta['title'] = "Profile";
include('header.php');
?>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="form-group">
									...
									<div class="col-sm-8 jrequired">
										<input type="text" name="mobile" id="mobile" readonly="" value="<?php echo $profile->mobile;?>" class="form-control" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-4 control-label">Email :</label>
									<div class="col-sm-8 jrequired">
										<input type="text" name="email" id="email" readonly="" value="<?php echo $profile->email;?>" class="form-control" />
									</div>
								</div>
								<div class="form-group">

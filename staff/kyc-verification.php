					...
					<div class="box-body">
						<div class="row">		
							<div class="col-md-6 col-md-offset-3 padding-top-20">
								<?php if(($validatedby=='0' || $validatedby==$_SESSION['staff']) && ($status=='0' || $status=='2')) {?>
								<div class="form-group">
									<div class="col-xs-12">
										<label>
								...
								<div class="form-group">
									<div class="col-xs-12">
										<b>Last Updated by  <?php echo $admins->fullname;?>, On date <?php echo date("d/m/Y h:i A", strtotime($validatedate));?> </b>
									</div>
								</div>
								<?php } ?>
							</div>

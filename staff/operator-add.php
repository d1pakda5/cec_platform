...
if(isset($_POST['submit'])) {
	if($_POST['service_type'] == '' || $_POST['operator_name'] == '' || $_POST['operator_code'] == '') {
		...
		if($exists) {
			...
			$db->execute("INSERT INTO `operators`(`operator_id`, `operator_name`, `operator_code`, `operator_longcode`, `service_type`, `minimum_amount`, `maximum_amount`, `code_egpay`, `service_type_egpay`, `code_arroh`, `code_achariya`, `code_modem`, `code_modem_rp`, `code_roundpay`, `code_exioms`, `service_type_exioms`, `code_aarav`, `service_type_aarav`, `code_ambika`, `code_cyberplat`, `code_offline`, `api_id`, `surcharge`, `surcharge_amount`, `status`) VALUES ('', '".$operator_name."', '".$operator_code."', '".$operator_longcode."', '".$_POST['service_type']."', '".$min_amount."', '".$max_amount."', '".$code_egpay."', '".$service_type_egpay."', '".$code_arroh."', '".$code_achariya."', '".$code_modem."', '".$code_modem_rp."', '".$code_roundpay."', '".$code_exioms."', '".$service_type_exioms."', '".$code_aarav."', '".$service_type_aarav."', '".$code_ambika."', '".$code_cyberplat."', '".$code_offline."', '".$_POST['api']."', '".$_POST['surcharge']."', '".$_POST['sur_amount']."', '".$_POST['status']."')");
			$error = 3;
		}		
	}
}

...
if(isset($_POST['submit'])) {
	if($_POST['service_type'] == '' || $_POST['operator_name'] == '' || $_POST['operator_code'] == '') {
		...
		if($exists) {
			...
			$db->execute("UPDATE `operators` SET `operator_name`='".$operator_name."', `operator_code`='".$operator_code."', `operator_longcode`='".$operator_longcode."', `service_type`='".$_POST['service_type']."', `minimum_amount`='".$min_amount."', `maximum_amount`='".$max_amount."', `code_egpay`='".$code_egpay."', `service_type_egpay`='".$service_type_egpay."', `code_arroh`='".$code_arroh."', `code_achariya`='".$code_achariya."', `code_modem`='".$code_modem."', `code_modem_rp`='".$code_modem_rp."', `code_roundpay`='".$code_roundpay."', `code_exioms`='".$code_exioms."', `service_type_exioms`='".$service_type_exioms."', `code_aarav`='".$code_aarav."', `service_type_aarav`='".$service_type_aarav."', `code_ambika`='".$code_ambika."', `code_cyberplat`='".$code_cyberplat."', `code_offline`='".$code_offline."', `api_id`='".$_POST['api']."', `surcharge`='".$_POST['surcharge']."', `surcharge_amount`='".$sur_amount."', `status`='".$_POST['status']."' WHERE operator_id = '".$request_id."' ");
			if($_POST['is_express'])
			{
			$db->execute("UPDATE `operators` SET  `is_express`='".$_POST['is_express']."' WHERE operator_id = '".$request_id."' ");
			}
			if($_POST['is_express']=='0')
			{
			$db->execute("UPDATE `operators` SET  `is_express`='".$_POST['is_express']."' WHERE operator_id = '".$request_id."' ");
			}
			$error = 3;

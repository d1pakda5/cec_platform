...
if(isset($_POST['submit'])) {
	if($_POST['fullname']=='' || $_POST['company_name']=='' || $_POST['address']=='' || $_POST['state']=='' || $_POST['status']=='') {
		...
		if($exists) {
			...
			$db->execute("UPDATE `apps_user` SET `fullname`='".$fullname."',`company_name`='".$company_name."', `email`='".$email."', `address`='".$address."', `city`='".$city."', `states`='".$_POST['state']."', `pincode`='".$pincode."', `phone`='".$phone."', `aadhaar`='".$aadhaar."', `panno`='".$panno."', `tds_deduct`='".$tds_deduct."', `tds_per`='".$tds_per."', `panno`='".$panno."', `gst_deduct`='".$gst_deduct."', `has_gst`='".$has_gst."', `gstin`='".$gstin."', `gst_type`='".$_POST['gst_type']."', `bill_address`='".$bill_address."', `bill_pincode`='".$bill_pincode."', `bill_city`='".$bill_city."', `bill_state`='".$_POST['bill_state']."', `is_access`='".$is_access."', `is_verified`='".$is_verified."', `assign_id`='".$_POST['assign_id']."', `status`='".$_POST['status']."', `is_fos`='".$_POST['is_fos']."' WHERE user_id='".$request_id."' ");
						...
						<div class="row padding-50">
							<div class="col-md-6">
								...
								<div class="form-group">
									...
									<div class="col-sm-8 jrequired">
										<input type="text" name="pincode" id="pincode" value="<?php echo $user->pincode;?>" class="form-control">
									</div>
								</div>
							</div>
							<div class="col-md-6">

...
ob_start();
$data[] = array('S.No', 'Txn No', 'API Name', 'Mode', 'Recharge Date', 'Retailer Name', 'Retailer UID', 'Account Number', 'Operator', 'Service', 'Amount', 'Surcharge', 'Status', 'Status Detail', 'Request Txn No', 'API Txn No', 'API Status', 'Operator Ref No', 'Status Changed','Refunded', 'IP Address');

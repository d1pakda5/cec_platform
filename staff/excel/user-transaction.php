...
ob_start();
$data[] = array('S.No', 'Txn Date', 'User Details','ACC. Mngr', 'Type','Opening Balance', 'Debit Amount', 'Credit Amount', 'Closing Balance','Calculation','Difference', 'Term', 'Ref Txn No', 'Remark', 'User Type', 'Transaction User');
...
while($result = $db->fetchNextObject($query)) {
	...
	$data[] = array($scnt++, $result->transaction_date,$result->uid,  $result->company_name,  $result->fullname, $result->type,$opening_balance, $debit_amount, $credit_amount, $result->closing_balance,$cal,$diff , $result->transaction_term, $result->transaction_ref_no, $result->remark, $result->transaction_user_type, $result->transaction_by,$opening_balance);

...
if($date=='all') {
	...
	$dtTo = "2018-03-31 23:23:59";
}
$sWhere = "WHERE gst.rch_date BETWEEN '".$dtFrom."' AND '".$dtTo."' AND gst.has_gst='1' ";
if(isset($_GET['utype']) && $_GET['utype']!='') {
	$sWhere .= " AND gst.user_type='".mysql_real_escape_string($_GET["utype"])."' ";
} else {
	$sWhere .= " AND gst.user_type IN (1,4) ";
}
...
$self = $tbl->remove_page_param('rpt-gst-invoice.php');
//
				...
				<table class="table table-condensed table-striped table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td align="center"><a href="gst-p2p.php?id=<?php echo $row->uid;?>&month=<?php echo $month;?>&year=<?php echo $year;?>" target="_blank" class="btn btn-success btn-xs">P2P</a></td>
							<td align="center"><a href="gst-p2s.php?id=<?php echo $row->uid;?>&month=<?php echo $month;?>&year=<?php echo $year;?>" target="_blank" class="btn btn-success btn-xs">Surcharge</a></td>
							<td align="center"><a href="gst-p2a.php?id=<?php echo $row->uid;?>&month=<?php echo $month;?>&year=<?php echo $year;?>" target="_blank" class="btn btn-success btn-xs">P2A</a></td>
							<td align="center"><a href="gst-p2d.php?id=<?php echo $row->uid;?>&month=<?php echo $month;?>&year=<?php echo $year;?>" target="_blank" class="btn btn-warning btn-xs">Receipt</a></td>
							<td align="center"><a href="gst-excel.php?id=<?php echo $row->uid;?>&month=<?php echo $month;?>&year=<?php echo $year;?>" target="_blank" class="btn btn-info btn-xs">Statement</a></td>
						</tr>
						<?php } ?>
					</tbody>
				</table>

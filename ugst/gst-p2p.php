	...
	<div class="container">
		<div id="divPrint">
			...
			<table class="table table-bordered">
				...
				<?php
				$a_statement = "SELECT SUM(rch_amount) AS amount, SUM(rch_comm_value) AS comm FROM gst_monthly_txns $sWhere AND item_group='1'";
				$a = $gst->getItemP2P($a_statement,'1');
				?>
				<tr>
					<td>1.
					...
					<td align="right"><?php echo $a['amount'];?></td>
					<td><?php echo $a['rate'];?></td>
					<td>Unit</td>
					<td align="right" class="tot_netamt"><?php echo $a['taxable'];?></td>
				</tr>
				<?php
				$b_statement = "SELECT SUM(rch_amount) AS amount, SUM(rch_comm_value) AS comm FROM gst_monthly_txns $sWhere AND item_group='2'";
				$b = $gst->getItemP2P($b_statement,'2');
				?>				
				<tr>
					<td>2.
					...
					<td align="right"><?php echo $b['amount'];?></td>

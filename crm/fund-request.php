...
$aFrom = date("Y-m-d 00:00:00", strtotime("-2 DAYS", strtotime($from)));
$aTo = date("Y-m-d 23:59:59", strtotime($to));

$sWhere = "WHERE rqst.user_type='3' AND user.assign_id='".$_SESSION['accmgr']."' ";
						...
						<div class="col-sm-2">
							<div class="form-group">
								<select name="status" id="status" class="form-control">
									...
									<?php 
									$array['pay_status'] = getPaymentStatusList();
					...
					<tbody>
						...
						<tr>
							...
							<td style="text-align:center;">
								<span class="btn btn-xs btn-default"><?php echo getPaymentStatus($array['pay_status'],$result->status);?></span>
							</td>
						</tr>
						<?php } ?>
					</tbody>

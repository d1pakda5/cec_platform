...
include("../../config.php");
 if($_POST['admin_id'] != '') {
	echo "<option value=''>--Select Retailor--</option>";
    $query = $db->query("SELECT company_name,mobile,uid FROM apps_user where assign_id='".$_POST['admin_id']."' and status='1' and user_type='5'");

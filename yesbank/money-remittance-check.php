...
$moneyRemittance = $yb->cpBeneficiaryRemittance($account,$request_txn_no,$ben_id,$ben_name,$ben_account,$ben_bank,$ben_ifsc,$kyc_status,$amount,$amount_all);	
$signInResult = $yb->cpIprivSign($moneyRemittance);

				...
				<table class="table table-condensed table-striped table-bordered">
					...
					<tbody>
						...
						<td style="text-align:center;">
							...
							<td style="text-align:center;">
								<?php if($result->is_success=='1') {?>
								<a href="#" onClick="actionRow('<?php echo $result->user_id;?>', 'nosuccess');" title="NS">
									<i class="fa fa-check-square-o text-green"></i>
								</a>
								<?php } else { ?>
								<a href="#" onClick="actionRow('<?php echo $result->user_id;?>', 'success');" title="SS">

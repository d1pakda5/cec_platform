...
$statement = "tickets ticket LEFT JOIN apps_user user ON ticket.submited_by = user.uid $sWhere AND ticket.status=0 ORDER BY ticket.submit_date,ticket.last_reply_date DESC";
//Pagination

...
function doExcel(){
	...
	var uid = $('#uid').val();
	var type = $('#type').val();
	window.location='excel/gst-invoices.php?month='+month+'&utype='+utype+'&uid='+uid+'&type='+type;
}
</script>
				...
				<table class="table table-condensed table-striped table-bordered">
					...
					<tfoot>
						<tr>
							...
							<td align="right"><b><?php echo $subtotal_sum;?></b></td>
							<td align="right"><b><?php echo $sgst_sum;?></b></td>
							<td align="right"><b><?php echo $cgst_sum;?></b></td>
							<td align="right"><b><?php echo $igst_sum;?></b></td>
							<td align="right"><b><?php echo $total_sum;?></b></td>
							<td colspan="2"></td>
						</tr>
					</tfoot>
				</table>

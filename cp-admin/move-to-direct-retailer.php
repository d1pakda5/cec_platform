...
if(isset($_POST['submit'])) {
	if($_POST['pin']=='') {
		...
		if($admin_info && $admin_info->pin==hashPin($_POST['pin'])) {
			$db->execute("UPDATE apps_user SET mdist_id='0', dist_id='0', user_type='6' WHERE user_id='".$request_id."' AND user_type='5'");
			$error = 3;
		} else {
			$error = 2;
		}	
						...
						<div class="row padding-50">
							<div class="col-sm-6 col-sm-offset-3">
								...
								<div class="form-group">
									<div class="text-red">
										If you are confirm to move, the retailer will move to the direct retailer. so before you will proceed please confirm. 
									</div>
								</div>
								<div class="form-group">

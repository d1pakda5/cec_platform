...
$sWhere = "WHERE comp.status = '1' ";

if(isset($_GET['s']) && $_GET['s'] != '') {
	$sWhere .= " AND ( comp.txn_no = '".mysql_real_escape_string($_GET['s'])."' ) ";
}
else{
    $sWhere .= " AND comp.complaint_date BETWEEN '".$aFrom."' AND '".$aTo."' ";
}
...
$self = $tbl->remove_page_param('complaints-closed.php');
...
<div class="content">
	<div class="container-fluid">
		<div class="page-header">
			<div class="page-title">Complaints <small>/closed</small></div>
		...
		<div class="box">
			<div class="box-header">
				<h3 class="box-title"><i class="fa fa-list"></i> List Closed Complaints</h3>
			</div>			
				...
				<table class="table table-striped table-bordered table-condensed">
					...
					<tbody>
						...
						<tr>
							...
							<td> 
								<a class="fancyDetails fancybox.ajax" href="complaint-reopen.php?id=<?php echo $result->recharge_id;?>&cid=<?php echo $result->complaint_id;?>" title="Complaint Details"><img src="../images/comp_0.png" /></a>
							</td>
							<td> 
								<a class="fancyDetails fancybox.ajax" href="action-log.php?type=complaint&id=<?php echo $result->complaint_id;?>" title="User Details"><img src="../images/users.png" /></a>
							</td>
						</tr>
						<?php } ?>
					</tbody>

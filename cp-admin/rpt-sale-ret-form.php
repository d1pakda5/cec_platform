...
$meta['title'] = "Monthly Retailer Sale Report";
include('header.php');
?>
...
<div class="content">
	<div class="container-fluid">
		<div class="page-header">
			<div class="page-title"> Monthly Retailer Sale Report <small>Select month/year</small></div>
		...
		<div class="row">
			<div class="col-sm-8">
				<div class="box">
					...
					<form action="monthly_ret_sale_rpt.php" method="GET" id="" class="form-horizontal">

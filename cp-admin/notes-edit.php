						...
						<div class="row">
							<div class="col-md-12">								
								...
								<div id="textPane" class="form-group" >
									...
									<div class="col-sm-9 jrequired">
										<textarea name="description" id="description" class="form-control" placeholder="Enter text content here" rows="15"><?php echo stripslashes($note_info->description);?></textarea>
									</div>
								</div>
							</div>
						</div>

...
if(isset($_POST['delete'])) {
    	...
    	$db->execute("Delete from `mobile_sms` WHERE id = '".$_POST['delete']."' ");
    }
...
$sWhere = "WHERE id != '' ";
// $sWhere .= " AND sms_date BETWEEN '".$aFrom."' AND '".$aTo."' ";
if(isset($_GET['s']) && $_GET['s'] != '') {
	$sWhere .= " AND ( provider LIKE '%".mysql_real_escape_string($_GET['s'])."%' OR msg LIKE '%".mysql_real_escape_string($_GET['s'])."%' )  ";
} else {
	$sWhere .= " AND sms_date BETWEEN '".$aFrom."' AND '".$aTo."' ";
}

$statement = "mobile_sms $sWhere ORDER BY sms_date DESC";
...
$self = $tbl->remove_page_param('rpt-received-sms.php');

$meta['title'] = "Mobile SMS Reports";
include('header.php');
?>
<script>
...
<div class="content">
	<div class="container-fluid">
		<div class="page-header">
			<div class="page-title">Reports <small>/ Mobile SMS</small></div>
		</div>
		<div class="box">
			<div class="box-header">
				<h3 class="box-title"><i class="fa fa-list"></i> List Mobile SMS</h3>
			</div>			
				...
				<table class="table table-basic table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td><?php echo $result->sms_date;?></td>
							<td><?php echo $result->provider;?></td>
							<td><?php echo $result->msg;?></td>
								<td style="text-align:center;">
								 <button type="submit" title="Delete"  name="delete" value="<?php echo $result->id;?>" class="btn btn-danger" /><i class="fa fa-trash"></i></button>&nbsp; &nbsp; &nbsp;    

...
$trans_info = $db->queryUniqueObject("SELECT * FROM transactions_adm WHERE txnadmid='".$request_id."' ");
if($trans_info) { 
	$user_info = $db->queryUniqueObject("SELECT * FROM apps_user WHERE uid='".$trans_info->txntouid."' ");
	if($user_info) {
	...
	<div class="box-body no-padding">
		<div class="body-inner">			
			...
			<form action="" method="post" id="frmRefund" class="form-horizontal">
				<input type="hidden" name="txnamount" id="txnamount" value="<?php echo $trans_info->txnamount;?>" />
				<input type="hidden" name="txnuid" id="txnuid" value="<?php echo $trans_info->txntouid;?>" />
				<input type="hidden" name="txnadmid" id="txnadmid" value="<?php echo $trans_info->txnadmid;?>" />
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<p class="form-control-static"><b><?php echo $trans_info->txnamount;?> Rs</b></p>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-4 control-label">Closing Balance</label>
					<div class="col-md-8">
						<p class="form-control-static"><?php echo $trans_info->closingbalance;?> Rs</p>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-4 control-label">Date</label>
					<div class="col-md-8">
						<p class="form-control-static"><?php echo date(("d-m-Y H:i:s A"), strtotime($trans_info->txndate));?></p>
					</div>
				</div>
				<div class="form-group">

	...
	<div class="container-fluid">
		<div class="page-header">
			...
			<div class="pull-right">
				...
				<a href="kyc.php?id=<?php echo $request_id;?>" class="btn btn-default"><i class="fa fa-eye"></i> KYC</a>
			</div>
		</div>
		<?php if($error == 3) { ?>

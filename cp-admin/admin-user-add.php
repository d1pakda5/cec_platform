...
if(isset($_POST['submit'])) {
	if($_POST['fullname'] == '' || $_POST['mobile'] == '' || $_POST['email'] == '' || $_POST['status'] == '' || $_POST['username'] == '' || $_POST['password'] == '' || $_POST['pin'] == '') {
		...
		if($exists) {
			...
			$db->execute("INSERT INTO `apps_admin`(`admin_id`, `username`, `password`, `pin`, `fullname`, `email`, `mobile`, `user_level`, `added_date`, `last_login_time`, `last_login_ip`, `status`) VALUES ('', '".$username."', '".$hashPassword."', '".$hashPin."', '".$fullname."', '".$email."', '".$mobile."', '".$_POST['user_level']."', NOW(), '', '', '".$_POST['status']."')");	
			if($email != '') {
								...
								<div class="form-group">
									...
									<div class="col-sm-8 jrequired">
										<select name="user_level" id="user_level" class="form-control">
											...
											<option value="u">Staff User</option>

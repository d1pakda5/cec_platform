...
//
$scnt = 1;
$query = $db->query("SELECT rch.*,opr.operator_name,opr.billing_type,opr.is_surcharge,usr.user_type,usr.company_name,usr.states,ucm.comm_ret,ucm.comm_api FROM {$statement}");
...
$xls->addArray($data);
$xls->generateXML('retailer_gst_recharge_wise_'.$from.'_to_'.$to);
ob_end_flush();
...
if(isset($_POST['submit'])) {
	if($_POST['old_mobile'] == '' || $_POST['confirm_mobile'] == '') {
		...
		if($exists) {
			...
			$db->execute("INSERT INTO `mobile_change_request`(`request_id`, `request_user`, `request_to`, `mobile_old`, `mobile_new`, `request_date`, `request_status`) VALUES ('', '".$_SESSION['distributor_uid']."', '0', '".$old_mobile."', '".$confirm_mobile."', NOW(), '0')");
			$error = 3;	
		}	
	}
}
				...
				<div class="box">
					...
					<div class="box-body min-height-300">
						<table class="table table-basic">
							...
							<tbody>
								<?php
								$query = $db->query("SELECT * FROM mobile_change_request WHERE request_user = '".$_SESSION['distributor_uid']."' ORDER BY request_date DESC LIMIT 10 ");

...
$aDistributor = $db->queryUniqueObject("SELECT * FROM apps_user WHERE uid = '".$_SESSION['distributor_uid']."' ");
$aWhiteLabel = $db->queryUniqueObject("SELECT * FROM website_profile WHERE website_uid = '".$aDistributor->dist_id."'");
if($aWhiteLabel) {

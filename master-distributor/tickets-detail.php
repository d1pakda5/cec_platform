...
if(isset($_POST['submit'])) {	
	if($_POST['reply'] == '' || $_POST['status'] == '') {
		...
		$db->execute("INSERT INTO `tickets_reply`(`reply_id`, `ticket_id`, `message`, `uid`, `reply_date`) VALUES ('', '".$request_id."', '".$reply."', '".$_SESSION['mdistributor_uid']."', NOW())");		
...
$ticket = $db->queryUniqueObject("SELECT * FROM tickets WHERE ticket_id = '".$request_id."' AND submited_by = '".$_SESSION['mdistributor_uid']."' ");

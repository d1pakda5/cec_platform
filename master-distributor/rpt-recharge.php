...
$ret = '';
$qry = $db->query("SELECT uid FROM apps_user WHERE mdist_id = '".$_SESSION['mdistributor_uid']."' ");
						...
						<div class="col-sm-3">
							<div class="form-group">
								<select name="u" id="u" class="form-control">
									<option value=""></option>
									<?php
									$query = $db->query("SELECT * FROM apps_user WHERE status = '1' AND mdist_id = '".$_SESSION['mdistributor_uid']."' ");

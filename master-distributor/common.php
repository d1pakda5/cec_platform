...
$aMaster = $db->queryUniqueObject("SELECT * FROM apps_user WHERE uid = '".$_SESSION['mdistributor_uid']."' ");
$aWhiteLabel = $db->queryUniqueObject("SELECT * FROM website_profile WHERE website_uid = '".$_SESSION['mdistributor_uid']."' ");
if($aWhiteLabel) {

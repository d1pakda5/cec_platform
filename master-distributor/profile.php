...
if(isset($_POST['submit'])) {	
	if($_POST['fullname']=='' || $_POST['email']=='' || $_POST['address']=='' || $_POST['state']=='' || $_POST['city']=='' || $_POST['pincode']=='' || $_POST['panno']=='' || $_POST['aadharno']=='') {
		...
		if($exists) {
			...
			$db->execute("INSERT INTO `verificationlog`(`uid`, `type`, `verifystatus`) VALUES ('".$aMaster->uid."', '1', '0')");
			$error = 3;
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-12">
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<div class="col-sm-8 jrequired">
										<input type="text" name="uid" id="uid" disabled="disabled" value="<?php echo $aMaster->uid;?>" class="form-control">
									</div>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									...
									<div class="col-sm-8 jrequired">
										<input type="text" name="username" id="username" disabled="disabled" value="<?php echo $aMaster->username;?>" class="form-control">
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									...
									<div class="col-sm-8 jrequired">
										<input type="text" name="fullname" id="fullname" value="<?php echo $aMaster->fullname;?>" class="form-control" placeholder="Enter your full name" />
									</div>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									...
									<div class="col-sm-8 jrequired">
										<input type="text" name="company_name" id="company_name" value="<?php echo $aMaster->company_name;?>"<?php if($aMaster->company_name!='') { ?> readonly="readonly"<?php } ?> class="form-control" placeholder="Enter your company name" />
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									...
									<div class="col-sm-8 jrequired">
										<input type="text" name="mobile" id="mobile" readonly="" value="<?php echo $aMaster->mobile;?>" class="form-control" placeholder="Enter mobile number" />
									</div>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									...
									<div class="col-sm-8 jrequired">
										<input type="text" name="phone" id="phone" value="<?php echo $aMaster->phone;?>" class="form-control" placeholder="Enter phone number" />
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									...
									<div class="col-sm-8 jrequired">
										<input type="text" name="email" id="email" value="<?php echo $aMaster->email;?>" class="form-control" placeholder="Enter email address" />
									</div>
								</div>	
							</div>
						</div>						
						<div class="row">
							<div class="col-sm-6">							
								<div class="form-group">
									...
									<div class="col-sm-8 jrequired">
										<textarea name="address" id="address" class="form-control" placeholder="Enter email address"><?php echo $aMaster->address;?></textarea>
									</div>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									...
									<div class="col-sm-8 jrequired">
										<input type="text" name="city" id="city" value="<?php echo $aMaster->city;?>" class="form-control">
									</div>
								</div>
							</div>
						</div>
						<div class="row">
								...
								<div class="form-group">
									...
									<div class="col-sm-8 jrequired">
										<select name="state" id="state" class="form-control">
											...
											<option value="<?php echo $rlt->states;?>" <?php if($aMaster->states==$rlt->states) {?>selected="selected"<?php } ?>><?php echo $rlt->states;?></option>
											<?php } ?>
										</select>
									</div>
								</div>
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<div class="col-sm-8 jrequired">
										<input type="text" name="pincode" id="pincode" value="<?php echo $aMaster->pincode;?>" class="form-control">
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									...
									<div class="col-sm-8 jrequired">
										<input type="text" name="panno" id="panno" value="<?php echo $aMaster->panno;?>"<?php if($aMaster->panno!='') { ?> readonly="readonly"<?php } ?> class="form-control">
									</div>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									...
									<div class="col-sm-8 jrequired">
										<input type="text" name="aadharno" id="aadharno" value="<?php echo $aMaster->aadharno;?>"<?php if($aMaster->aadharno!='') { ?> readonly="readonly"<?php } ?> class="form-control">
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									...
									<div class="col-sm-8 jrequired">
										<input type="text" name="gstin" id="gstin" value="<?php echo $aMaster->gstin;?>"<?php if($aMaster->gstin!='') { ?> readonly="readonly"<?php } ?> class="form-control">
									</div>
								</div>
							</div>
						</div>						
				...
				<p>Your account has been registered on <?php echo date("d/F/Y", strtotime($aMaster->added_date));?>.
				<?php if($aMaster->update_date!='0000-00-00 00:00:00') {?>
				&nbsp; Last update on <?php echo date("d/F/Y H:i A", strtotime($aMaster->update_date));?> from IP <?php echo $aMaster->updateip;?>
				<?php } ?>
				</p>
			</div>
		</div>

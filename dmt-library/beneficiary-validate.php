...
if(strpos($checkExplode['6'], 'ERROR=0')!==false) {
	...
	if(strpos($payExplode['6'], 'ERROR=0')!==false) {
		...
		$jsResponse = '{"ResponseCode":"0","Message":"Verification for beneficary is successful.","RequestNo":"'.$jsFetch['RequestNo'].'","MobileNo":"'.$jsFetch['MobileNo'].'","MoneyRemittance":'.$jsMoneyRemittance.',"Beneficiary":'.$jsBeneficiary.'}';		
		echo $jsResponse;
		exit();

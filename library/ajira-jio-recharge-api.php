<?php
	...
	*/
	...
	$url ="http://ajira.online/Jio.asmx/Recharge?macID=c4:0b:cb:64:60:7d&posID=101&userID=0682184292&cName=Aniketsales&password=".$operator_info->password."&number=".$account."&amount=".$amount;	

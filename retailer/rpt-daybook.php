	...
	<div class="container">
		...
		<div class="box">
			...
			<div class="box-body no-padding min-height-480">
				...
				$recharge_amt = $db->queryUniqueValue("SELECT sum(amount) from apps_recharge where status in(0,1,8) and uid='".$uid."'  and request_date between '".$aFrom."' AND '".$aTo."' ");
				...
				<table class="table table-bordered table-basic">
					...
					<tbody>
						...
						<tr>
						    <td><a class="btn btn-primary" data-toggle="collapse" href="#details" role="button" aria-expanded="false" aria-controls="details"><i class="fa fa-plus"></i></a></td>
							<td><?php echo $uid;?></td>

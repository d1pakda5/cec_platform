...
if(isset($_POST['submit'])) {
	if($_POST['title'] == '' || $_POST['message'] == '' || $_POST['urgency'] == '') {
		...
		$db->execute("INSERT INTO `tickets`(`ticket_id`, `submited_by`, `title`, `message`, `urgency`, `submit_date`, `is_read`, `is_admin_read`, `last_reply_date`, `status`) VALUES ('', '".$_SESSION['apiuser_uid']."', '".$title."', '".$message."', '".$_POST['urgency']."', NOW(), '0', '0', NOW(), '".$_POST['status']."')");
		$error = 3;		
	}
}

...
$statement = "transactions WHERE account_id = '".$_SESSION['apiuser_uid']."' AND transaction_term = 'FUND' AND transaction_date BETWEEN '".$aFrom."' AND '".$aTo."' ORDER BY transaction_id DESC";
...
$self = $tbl->remove_page_param('rpt-fund-transfer.php');

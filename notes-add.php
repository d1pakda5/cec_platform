						...
						<div class="row">
							<div class="col-md-10">	
								...
								<div id="textPane"  class="form-group">
									...
									<div class="col-sm-9 jrequired">
										<textarea name="data" id="data" rows="50" cols="100"></textarea>
									</div>
								</div>
								<div id="reminder" style="display:none" class="form-group">
									<label class="col-sm-3 control-label">Reminder Description :</label>
									<div class="col-sm-9 jrequired">
										<textarea name="reminder_description" id="reminder_description" class="form-control" placeholder="Enter text content here" rows="10"></textarea>
									</div>
								</div>
								<div id="date_from" style="display:none" class="form-group">
									<label class="col-sm-3 control-label">Reminder From Date :</label>
									<div class="col-sm-5 jrequired">
									    <input type="text" size="10" name="reminder_date_from" id="reminder_date_from" value="" placeholder="Reminder From Date " class="form-control">
									</div>
								</div>
